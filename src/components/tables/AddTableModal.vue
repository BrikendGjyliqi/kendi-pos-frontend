...
const name = ref('')
const seatCount = ref<number>(4)
const section = ref<Section>('MAIN_DINING')
...
const nameValid = computed(() => {
  ...
  if (props.existingNames.includes(trimmed)) return false
  return true
})
  ...
  <div class="modal-backdrop" @click="handleBackdropClick">
    <div class="modal">
      <div class="modal-head">
        <div>
          <h2>Add new table</h2>
          <p class="subtitle">Only administrators can add tables</p>
        </div>
      ...
      <div class="modal-body">
        <div class="form-column">
          ...
          <div class="field">
            <label>Position on floor plan</label>
            <div class="position-hint">
              <Plus :size="18" />
              <span>Drag on the floor plan after saving</span>
            </div>
          </div>
...
.position-hint {
  ...
  border: 0.5px dashed rgba(232, 228, 216, 0.2);
  border-radius: 8px;
  padding: 12px;
  display: flex;
  align-items: center;
