  ...
  <div class="admin">
    ...
    <aside class="sidebar">
      ...
      <nav class="nav">
        ...
        <RouterLink to="/admin/manage-tables" class="nav-link">
          <LayoutGrid :size="18" />
          Tavolinat
        </RouterLink>
        ...
        <RouterLink to="/admin/reservations-history" class="nav-link">
          <Archive :size="18" />
          Historia e rezervimeve
        </RouterLink>
        <RouterLink to="/admin/stock" class="nav-link">
          <Package :size="18" />
          Stoku
        </RouterLink>
        <RouterLink to="/admin/suppliers" class="nav-link">
          <Truck :size="18" />
          Furnitorët
        </RouterLink>
        <RouterLink to="/admin/delivery-history" class="nav-link">
